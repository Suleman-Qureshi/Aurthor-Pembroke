  ...
  return (
    <section className='w-screen flex max-lg:flex-col justify-between gap-2 px-24 max-lg:px-12 max-md:px-4 py-20'>
        ...
        <div className='relative w-full max-lg:flex max-lg:justify-center'>
            <div className='w-[29rem] max-xl:w-[24rem] h-[29rem] max-xl:h-[24rem] max-sm:h-[20rem] max-sm:w-[80%] max-lg:w-[30rem] bg-[url("/About-Image.jpg")] bg-center bg-cover top-4 max-lg:top-0 left-4 max-lg:left-1/2 max-lg:-translate-x-1/2 absolute'>
        ...
        <div className='w-3/5 max-xl:w-1/2 max-lg:w-full flex flex-col gap-4 max-sm:mt-12'>
