...
function HeroSection() {
  return (
    ...
    <section className='w-screen h-screen bg-[url("/heroImg.jpeg")] bg-no-repeat bg-center bg-cover bg-fixed font-heading'>
      <div className="w-full h-full bg-black/60 max-md:bg-black/80 flex flex-col text-center  justify-center   items-center gap-6 px-24 max-lg:px-12 max-md:px-4 pt-18 max-md:pt-12">
      <div className=' text-xl max-sm:text-sm uppercase text-[#FFFFF0] max-md:text-primary tracking-widest flex items-center gap-4 max-sm:gap-1 w-full justify-center'>Arthur pembroke <GoDotFill className='text-[#FFFFF0] max-md:text-primary' /> luxury concierge</div>
         ...
         <div className=' flex gap-4 items-center max-md:flex-col'>
          ...
          <Link href="/Services" className='w-44 py-4 text-center  uppercase text-sm tracking-[0.2rem] text-light text-primary border border-primary'>our services</Link>
         </div>
      </div>
    </section>
    </>
